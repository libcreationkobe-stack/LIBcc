...
/** 目安つきの4指標。 */
var METER_METRICS = [
  {key: 'フォロワー外率',   note: '新しい人にどれだけ届いたか'},
  {key: '保存シェア率',     note: '伸びの先行指標。ここが動くと翌月の表示が伸びる'},
...
var GLOSSARY = [
  ...
  ['フォロワー外率', 'フォロワー外リーチ ÷ リーチ数。新しい人に届いているか。ここが落ちると身内で回っている状態。'],
  ...
  ['LINE追加 達成率', 'LINE友だち追加 ÷ 月の目標。このシートのCVポイント。目標は採用したい人数から逆算する。']
];
